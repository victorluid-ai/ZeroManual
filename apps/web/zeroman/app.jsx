...
const T = {
  ...
  es: {
    ...
    filters: { all: "Todas", reviews: "Reseñas", social: "Redes", email: "Email", messaging: "Mensajes" },
    ...
    example: { kicker: "Demo en directo", title: "Míralo funcionar, en directo", sub: "Entra una tarea. ZeroManual la resuelve con tu tono. Tú no haces nada. Desliza para ver más." },
...
const PRODUCTS = [
  ...
  { id: "newsletter", cat: "email", price: 24, badge: "",
    ...
    es: { name: "Enviar newsletters", catLabel: "Email", connect: "Mailchimp o Gmail", tagline: "Boletines por email creados a partir de las novedades de tu negocio.", features: ["Redacta desde tus novedades y ofertas", "Emails con tu marca, listos para móvil", "Envía cada semana o cada mes"], about: "ZeroManual convierte tus últimas ofertas, eventos y novedades en un boletín limpio y con tu marca, y lo envía a tu lista cada semana o cada mes — sin escribir nada.", exInLabel: "Novedades", exIn: "Lanzamiento del menú de verano y nuevo horario", exOutLabel: "Newsletter enviada", exOut: "Asunto: «Ya está aquí el menú de verano 🌞» — enviada a 1.240 suscriptores" } },
  ...
  { id: "reminders", cat: "messaging", price: 19, badge: "",
    ...
    es: { name: "Recordatorios de citas", catLabel: "Mensajes", connect: "Tu calendario + SMS", tagline: "Envía recordatorios por SMS para reducir las ausencias automáticamente.", features: ["Recordatorios por SMS y email", "Confirmar o reprogramar con un clic", "Se sincroniza con tu calendario"], about: "ZeroManual envía a tus clientes un recordatorio por SMS y email antes de su cita y les permite confirmar o reprogramar con un solo clic, reduciendo las ausencias automáticamente.", exInLabel: "Cita en tu calendario", exIn: "Ana Ruiz — corte y color, mañana 10:00", exOutLabel: "SMS enviado", exOut: "Hola Ana 👋 te recordamos tu cita de mañana a las 10:00. Responde 1 para confirmar o 2 para cambiarla." } },
  { id: "requests", cat: "reviews", price: 19, badge: "new",
    en: { name: "Request Reviews", catLabel: "Reviews", connect: "Google + SMS / email", tagline: "Asks happy customers for a Google review at the perfect moment.", features: ["Times requests after a visit", "One-tap review links", "Grows your star rating"], about: "After a visit or purchase, ZeroManual sends your happy customers a one-tap link to leave a Google review at exactly the right moment — steadily growing your rating.", exInLabel: "Visit completed", exIn: "Juan P. — paid his bill 2 hours ago", exOutLabel: "SMS sent", exOut: "Thanks for coming in, Juan! Would you leave us a quick review? One tap: g.page/cafeluma" },
    es: { name: "Pedir reseñas", catLabel: "Reseñas", connect: "Google + SMS / email", tagline: "Pide una reseña en Google a tus clientes contentos en el momento ideal.", features: ["Pide la reseña tras la visita", "Enlaces de reseña con un clic", "Sube tu puntuación de estrellas"], about: "Tras una visita o compra, ZeroManual envía a tus clientes contentos un enlace de un clic para dejar una reseña en Google justo en el momento adecuado — subiendo tu puntuación poco a poco.", exInLabel: "Visita completada", exIn: "Juan P. — pagó su cuenta hace 2 h", exOutLabel: "SMS enviado", exOut: "¡Gracias por tu visita, Juan! ¿Nos dejas una reseña? Solo un clic: g.page/cafeluma" } },
];
