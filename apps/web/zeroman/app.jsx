...
const T = {
  ...
  es: {
    ...
    login: {
      title: "Área privada", sub: "Accede con tu usuario o correo.",
      registerTitle: "Crear cuenta", registerSub: "Regístrate como cliente.",
      identLabel: "Usuario o correo", nameLabel: "Nombre", passLabel: "Contraseña",
